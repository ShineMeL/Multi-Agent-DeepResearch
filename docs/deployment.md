...
do not trust all networks. Preserve owner cookies and streaming responses at the
...
savers and engine connections. Startup reconciles queued/orphan runs and
persisted admission reservations; cancel of an interrupted run releases its
remaining reservation. Do not manually delete ledger rows to clear capacity.
